        ...
        {posts.length === 0 ? (
          <div className="py-8 text-center">
            ...
            {searchQuery ? (
              ...
              <img src="/curious-icon.jpg" alt="아직 없음" width={80} height={80} className="mx-auto mb-2 rounded-full" style={{ animation: "curious-wobble 3s ease-in-out infinite" }} />
            )}
            <p style={{ color: "#94A3B8" }} className="leading-tight">
              {searchQuery
                ? <>슈퍼베스트글 중 <span style={{ color: "#60A5FA" }} className="font-bold">&ldquo;{searchQuery}&rdquo;</span>에 대한 검색 결과가 없습니다.</>
                : "아직 왕좌가 비어있습니다!"}
            </p>
            {!searchQuery && (
